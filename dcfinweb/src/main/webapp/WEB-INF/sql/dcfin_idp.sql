CREATE TABLE `idp_group` (
  ...
  `idp_group_createdate` datetime NOT NULL,
...
CREATE TABLE `idp_user` (
  ...
  `DCF_IDP_USER_CREATE_TIME` datetime DEFAULT NULL,
...
CREATE TABLE `idp_user_profile` (
  ...
  `ididp_user_profile_createdate` datetime NOT NULL,
  PRIMARY KEY (`idp_user_profile_id`),
  UNIQUE KEY `ididp_user_profile_id_UNIQUE` (`idp_user_profile_id`),
  UNIQUE KEY `ididp_user_profile_createdate_UNIQUE` (`ididp_user_profile_createdate`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
